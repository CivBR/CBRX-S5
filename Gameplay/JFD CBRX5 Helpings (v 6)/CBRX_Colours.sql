...
SET IconAtlas = (SELECT NewIconAtlas FROM Civilization_CBRX_Colours WHERE NewIconAtlas IS NOT NULL AND CivilizationType = Type),
PortraitIndex = (SELECT NewPortraitIndex FROM Civilization_CBRX_Colours WHERE NewPortraitIndex <> -1 AND CivilizationType = Type)
