...
SELECT 	'ART_DEF_UNIT_EE_EXPLORER', 			'ART_DEF_UNIT_MEMBER_EE_EXPLORER_1',		1
FROM ArtDefine_UnitInfoMemberInfos WHERE UnitInfoType = 'ART_DEF_UNIT_SCOUT';

INSERT INTO ArtDefine_UnitInfoMemberInfos
		(UnitInfoType,							UnitMemberInfoType,							NumMembers)
SELECT 	'ART_DEF_UNIT_EE_EXPLORER', 			'ART_DEF_UNIT_MEMBER_EE_EXPLORER_2',		0
FROM ArtDefine_UnitInfoMemberInfos WHERE UnitInfoType = 'ART_DEF_UNIT_SCOUT';

INSERT INTO ArtDefine_UnitInfoMemberInfos
		(UnitInfoType,							UnitMemberInfoType,							NumMembers)
SELECT 	'ART_DEF_UNIT_EE_EXPLORER', 			'ART_DEF_UNIT_MEMBER_EE_EXPLORER_3',		0
FROM ArtDefine_UnitInfoMemberInfos WHERE UnitInfoType = 'ART_DEF_UNIT_SCOUT';

INSERT INTO ArtDefine_UnitInfoMemberInfos
		(UnitInfoType,							UnitMemberInfoType,							NumMembers)
SELECT 	'ART_DEF_UNIT_EE_EXPLORER', 			'ART_DEF_UNIT_MEMBER_EE_EXPLORER_4',		0
FROM ArtDefine_UnitInfoMemberInfos WHERE UnitInfoType = 'ART_DEF_UNIT_SCOUT';
