...
----------------------------------------------------------------
----------------------------------------------------------------
-- function OnDarkAge(playerID, isDarkAge)
-- 	if playerID == Game.GetActivePlayer() then
-- 		if isDarkAge then
-- 			Controls.DAOverlay:SetHide( false );
-- 		else
-- 			Controls.DAOverlay:SetHide( true );
--
-- 			Controls.DAOverlayFadeOut:SetHide( false );
-- 			Controls.DAOverlayFadeOut:BranchResetAnimation();
-- 		end
-- 	end
-- end
-- LuaEvents.JFD_DarkAgeBegins.Add(OnDarkAge);
----------------------------------------------------------------
----------------------------------------------------------------
-- function OnGoldenAge(playerID, isStart, turns)
-- 	if playerID == Game.GetActivePlayer() then
-- 		if isStart then
-- 			Controls.GAOverlay:SetHide( false );
-- 		else
-- 			Controls.GAOverlay:SetHide( true );
--
-- 			Controls.GAOverlayFadeOut:SetHide( false );
-- 			Controls.GAOverlayFadeOut:BranchResetAnimation();
-- 		end
-- 	end
-- end
...
-- 	if Players[Game.GetActivePlayer()]:IsGoldenAge() then
-- 		if Controls.GAOverlay:IsHidden() then
-- 			Controls.GAOverlay:SetHide( false );
-- 		end
-- 	else
-- 		if (not Controls.GAOverlay:IsHidden()) then
-- 			Controls.GAOverlay:SetHide( true );
--
-- 			Controls.GAOverlayFadeOut:SetHide( false );
-- 			Controls.GAOverlayFadeOut:BranchResetAnimation();
