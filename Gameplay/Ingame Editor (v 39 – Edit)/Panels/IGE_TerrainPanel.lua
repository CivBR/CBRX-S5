...
function OnInitialize()
	...
	--JFD
	CreateGroup(Controls.JFDOptionsContainer, L("TXT_KEY_JFD_IGE_OPTIONS"));
	--JFD
...
-------------------------------------------------------------------------------------------------
--JFD
-- function OnRemoveIllegalFeatures()
	-- JFD_CleanupIllegalTiles(true, false, false, Controls.EnableDebugging:IsChecked())
-- end
-- Controls.RemoveIllegalFeatures:RegisterCallback(Mouse.eLClick, OnRemoveIllegalFeatures);

function OnRemoveIllegalImprovements()
	JFD_CleanupIllegalTiles(false, false, true, Controls.EnableDebugging:IsChecked())
end
Controls.RemoveIllegalImprovements:RegisterCallback(Mouse.eLClick, OnRemoveIllegalImprovements);

function OnRemoveIllegalResources()
	JFD_CleanupIllegalTiles(false, true, false, Controls.EnableDebugging:IsChecked())
end
Controls.RemoveIllegalResources:RegisterCallback(Mouse.eLClick, OnRemoveIllegalResources);

function OnRemoveAllIllegals()
	JFD_CleanupIllegalTiles(true, true, true, Controls.EnableDebugging:IsChecked())
end
Controls.RemoveAllIllegals:RegisterCallback(Mouse.eLClick, OnRemoveAllIllegals);
--JFD
