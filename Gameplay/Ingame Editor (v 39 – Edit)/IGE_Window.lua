...
function OnOptionControlChanged()
	...
	if Controls.ToggleTotalWarCheckbox:IsChecked() ~= totalWarEnabled then
		ToggleTotalWarScripts();
	end
...
Controls.ToggleTotalWarCheckbox:RegisterCheckHandler(OnOptionControlChanged);
