...
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO
	BuildingClasses (Type, DefaultBuilding, Description, MaxGlobalInstances, MaxPlayerInstances)
VALUES
...
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO
	Civilization_BuildingClassOverrides (BuildingClassType, CivilizationType, BuildingType)
VALUES
...
VALUES
	...
	('BUILDING_JFD_POTALA_PALACE', 'BUILDINGCLASS_JFD_POTALA_PALACE', 0, -1, 0, null, null, 0, 1, 0, 0, 0, 0, 0, null, 0, 0, 0, 0, 'GOVERNMENT_JFD_THEOCRACY', 600, 'TECH_ASTRONOMY', 'ERA_INDUSTRIAL', 'SPECIALIST_SCIENTIST', 1, null, null, null, 'TXT_KEY_BUILDING_JFD_POTALA_PALACE', 'TXT_KEY_WONDER_JFD_POTALA_PALACE_HELP', null, 'TXT_KEY_WONDER_JFD_POTALA_PALACE_PEDIA', 'TXT_KEY_WONDER_JFD_POTALA_PALACE_QUOTE', 1, -1, -1, 100, null, 'JFD_SOVEREIGNTY_WONDER_ATLAS', 13, 'AS2D_WONDER_SPEECH_JFD_POTALA_PALACE', 'Wonder_PotalaPalace.dds', 'R,B'),
...
UPDATE Buildings
SET
	MutuallyExclusiveGroup = 121,
	Cost = 600,
	MustBeCapital = 1,
	FreePromotion = null,
	FreeBuildingThisCity = null,
	FoundsGovernment = 'GOVERNMENT_JFD_SHOGUNATE',
...
UPDATE Buildings
SET
	PrereqTech = 'TECH_JFD_JURISPRUDENCE'
WHERE
...
UPDATE Buildings
SET
	SovereigntyChange = 10
WHERE
	BuildingClass IN ('BUILDINGCLASS_PALACE', 'BUILDINGCLASS_JFD_CAIRO_CITADEL', 'BUILDINGCLASS_JFD_HOFBURG_PALACE', 'BUILDINGCLASS_JFD_MOSQUE_DAMASCUS', 'BUILDINGCLASS_JFD_ST_PETERS_BASILICA', 'BUILDINGCLASS_JFD_TEMPLE_OF_HEAVEN', 'BUILDING_HIMEJI_CASTLE')
	AND NOT EXISTS (
		SELECT
			Type
		FROM
...
WHERE
	...
	AND PolicyBranchType = 'POLICY_BRANCH_LIBERTY';
...
SET
	...
	PrereqTech = null
WHERE
	Type = 'BUILDING_EE_VERSAILLES';

UPDATE Buildings
SET
	PrereqTech = 'TECH_EE_SOVEREIGNTY'
WHERE
	Type = 'BUILDING_JFD_VERSAILLES'
	AND EXISTS (
		SELECT
			Type
		FROM
...
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO
	JFD_Civilopedia_HideFromPedia (Type)
VALUES
...
VALUES
	('BUILDING_JFD_POTALA_PALACE', 'UNIT_PROPHET', 1);

--------------------------------------------------------------------------------------------------------------------------
-- Building_JFD_SovereigntyMods
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO
	Building_JFD_SovereigntyMods (BuildingType, MaxSovChange)
VALUES
	('BUILDING_JFD_VERSAILLES', 30);

--------------------------------------------------------------------------------------------------------------------------
-- Building_ThemingBonuses
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO
	Building_ThemingBonuses (BuildingType, Description, Bonus, MustBeArt, AIPriority)
VALUES
	('BUILDING_JFD_VERSAILLES', 'TXT_KEY_THEMING_BONUS_JFD_VERSAILLES', 2, 1, 4);
