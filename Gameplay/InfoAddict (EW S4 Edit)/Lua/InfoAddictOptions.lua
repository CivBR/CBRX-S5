...
function UpdateOptionsDisplay()
	...
	Controls.HistoricalXAxisLabelCount:SetText(Locale.ConvertTextKey(
	"TXT_KEY_INFOADDICT_OPTIONS_HISTORICAL_XAXIS_LABEL_COUNT", string.format("%i", math.floor(value * maxNumXLabels()))));
	...
	Controls.HistoricalYAxisLabelCount:SetText(Locale.ConvertTextKey(
	"TXT_KEY_INFOADDICT_OPTIONS_HISTORICAL_YAXIS_LABEL_COUNT", string.format("%i", math.floor(value * maxNumYLabels()))));
end
...
function HistoricalXAxisLabelCountSliderChanged(value)
	...
	Controls.HistoricalXAxisLabelCount:SetText(Locale.ConvertTextKey(
	"TXT_KEY_INFOADDICT_OPTIONS_HISTORICAL_XAXIS_LABEL_COUNT", string.format("%i", i)));
...
function HistoricalYAxisLabelCountSliderChanged(value)
	...
	Controls.HistoricalYAxisLabelCount:SetText(Locale.ConvertTextKey(
	"TXT_KEY_INFOADDICT_OPTIONS_HISTORICAL_YAXIS_LABEL_COUNT", string.format("%i", i)));
