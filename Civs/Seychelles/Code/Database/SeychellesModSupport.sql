...
VALUES	('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_DECOLONIZATION',		2),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_MERCENARY',				6),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	0),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_GOVERNMENT',		7),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_LAW',			7),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_DIPLOMACY',		5),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_ECONOMY',		8),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_EDUCATION',		5),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_INDUSTRY',		4),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_MILITARY',		2),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_RELIGION',		0),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_SOCIETY',		8),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_REFORM_WELFARE',		9),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_SLAVERY',				1),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'FLAVOR_JFD_STATE_RELIGION',		0);
--==========================================================================================================================
-- CIVILIZATIONS
--==========================================================================================================================
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('CIVILIZATION_JWW_SEYCHELLES',	'Yagem',				47,		26),
		('CIVILIZATION_JWW_SEYCHELLES',	'Yahem',				82,		28),
		('CIVILIZATION_JWW_SEYCHELLES',	'Cordiform',			49,		10),
		('CIVILIZATION_JWW_SEYCHELLES',	'GreatestEarth',		69,		13),
		('CIVILIZATION_JWW_SEYCHELLES',	'EarthMk3',				51,		26),
		('CIVILIZATION_JWW_SEYCHELLES',	'Africa',				62,		29),
		('CIVILIZATION_JWW_SEYCHELLES',	'AfriGiant',			135,	65),
		('CIVILIZATION_JWW_SEYCHELLES',	'AfriAsiaAust',			57,		29),
		('CIVILIZATION_JWW_SEYCHELLES',	'AfriSouthEuro',		72,		27),
		('CIVILIZATION_JWW_SEYCHELLES',	'IndianOcean',			24,		34);
--------------------------------------------------------------------------------------------------------------------------	
-- Civilizations_YnAEMPRequestedResources
--------------------------------------------------------------------------------------------------------------------------	
INSERT INTO Civilizations_YnAEMPRequestedResources
		(CivilizationType,				MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4, Req5, Yield5, Req6, Yield6)
SELECT	'CIVILIZATION_JWW_SEYCHELLES',	MapPrefix, Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4, Req5, Yield5, Req6, Yield6
...
VALUES	('CIVILIZATION_JWW_SEYCHELLES',	'CULTURE_JFD_COLONIAL',	'_JFD_WESTERN',	'JFD_Colonial',	'JFD_Colonial',		'JFD_Colonial');
--------------------------------------------------------------------------------------------------------------------------	
...
VALUES	('CIVILIZATION_JWW_SEYCHELLES', 	'GOVERNMENT_JFD_DICTATORSHIP',	75),
		('CIVILIZATION_JWW_SEYCHELLES', 	'GOVERNMENT_JFD_REPUBLIC',		25);
--==========================================================================================================================
...
VALUES	('LEADER_JWW_FRANCE-ALBERT_RENE',	'RESPONSE_INFLUENTIAL_ON_AI',		'TXT_KEY_LEADER_JWW_FRANCE-ALBERT_RENE_INFLUENTIAL_ON_AI%',		1),
		('LEADER_JWW_FRANCE-ALBERT_RENE',	'RESPONSE_INFLUENTIAL_ON_HUMAN',	'TXT_KEY_LEADER_JWW_FRANCE-ALBERT_RENE_INFLUENTIAL_ON_HUMAN%',	1);
--=========================================================================================================================
...
SELECT  'LEADER_JWW_FRANCE-ALBERT_RENE',	'POLICY_SEAFARING_X',	'POLICY_CREATIVE_X'
WHERE EXISTS (SELECT * FROM Policies WHERE Type = 'POLICY_PHILOSOPHICAL_X');
------------------------------	
-- Leaders
------------------------------	
UPDATE Leaders 
SET Description = 'France-Albert René [ICON_ARROW_RIGHT][ICON_CULTURE]'
WHERE Type = 'LEADER_JWW_FRANCE-ALBERT_RENE'
...
WHERE Type = 'CIVILIZATION_JWW_SEYCHELLES'
...
SELECT	'CIVILIZATION_JWW_SEYCHELLES',	CultureType,			CultureEra
...
VALUES	('MOD_JWW_SEYCHELLES',		'TXT_KEY_MOD_JWW_SEYCHELLES_NAME',		'TXT_KEY_MOD_JWW_SEYCHELLES_MODID',	'TXT_KEY_MOD_JWW_SEYCHELLES_AUTHORS');
--------------------------------------------------------------------------------------------------------------------------
-- Achievopedia_Tabs
--------------------------------------------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS 
...
VALUES	('AA_JWW_SEYCHELLES_VICTORY',	'TXT_KEY_AA_JWW_SEYCHELLES_VICTORY_HEADER',	'TXT_KEY_AA_JWW_SEYCHELLES_VICTORY_TEXT',	'MOD_JWW_SEYCHELLES',	1,				'CIVILIZATION_JWW_SEYCHELLES',		'JWW_SEYCHELLES_COLOR_ATLAS',	2);
--------------------------------------------------------------------------------------------------------------------------
...
VALUES	('AA_JWW_SEYCHELLES_VICTORY',	'TAB_JWW_CIVS');
*/
--==========================================================================================================================
...
WHERE CivilizationType = 'CIVILIZATION_JWW_SEYCHELLES'
