...
SELECT		Class,		('UNIT_TCM_HEQA_KHASUT_FORT'),  null, 		115,	  Range, Combat, 11, 			 -1,   null, 			 -1, 		-1, 						  Moves, CombatClass, Domain, DefaultUnitAI, ('TXT_KEY_UNIT_TCM_HEQA_KHASUT'), ('TXT_KEY_CIVILOPEDIA_UNITS_MEDIEVAL_TCM_HEQA_KHASUT_TEXT'), 	('TXT_KEY_UNIT_TCM_HEQA_KHASUT_STRATEGY'), 	('TXT_KEY_UNIT_HELP_TCM_HEQA_KHASUT'), 	MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, AdvancedStartCost, Mechanized, CombatLimit, MinAreaSize, Pillage, XPValueAttack, XPValueDefense, Conscription, ('ART_DEF_UNIT_TCM_HEQA_KHASUT'),	0,					('TCM_UNIT_FLAG_HEQA_KHASUT_ATLAS'), 2, 				('TCM_HYKSOS_ATLAS'), MoveRate
FROM Units WHERE (Type = 'UNIT_CHARIOT_ARCHER');
--==========================================================================================================================	
