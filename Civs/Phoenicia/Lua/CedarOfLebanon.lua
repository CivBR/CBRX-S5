...
print ("loaded")
include( "Sukritact_SaveUtils.lua" ); MY_MOD_NAME = "CedarsofLebanonCode";

--=======================================================================================================================
-- Main Code
--=======================================================================================================================

local iPromotion = GameInfoTypes.PROMOTION_CEDARS_OF_LEBANON
...
function CedarsofLebanonCode(iPlayer)
	...
	if pTargetCity ~= nil then
		iMod = iMod + (GetGreatPersonModifier(pPlayer, pTargetCity, iMerchant))
	end
		...
		if pUnit:IsHasPromotion(iPromotion) then
			...
			if pTargetCity ~= nil then
				...
				if iOldXP ~= nil then
					...
					if iDelta > 0 then
						pTargetCity:ChangeSpecialistGreatPersonProgressTimes100(iMerchant, iDelta)
					end
				end
			end
		end
