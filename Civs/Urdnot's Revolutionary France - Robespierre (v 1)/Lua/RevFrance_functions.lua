...
-- Globals
----------------------------------------------------------------------------------------------------------------------------
local civilizationID					= GameInfoTypes["CIVILIZATION_US_FRANCE"]
local iGuillotine						= GameInfoTypes["BUILDING_US_GUILLOTINE"]
local iGuillotineSpecialDummy			= GameInfoTypes["BUILDING_US_ROBESPIERRE_HAPPINESS_DUMMY_SPECIAL"]
local pGuard							= GameInfoTypes["UNIT_US_REVOLUTIONARY_GUARD"]
