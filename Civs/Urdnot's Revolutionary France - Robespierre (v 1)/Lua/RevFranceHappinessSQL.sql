...
INSERT INTO BuildingClasses (Type, DefaultBuilding, Description) 
SELECT 'BUILDINGCLASS_US_ROBESPIERRE_HAPPINESS_DUMMY_'||Type, 'BUILDING_US_ROBESPIERRE_HAPPINESS_DUMMY_'||Type, Description
FROM Buildings WHERE Type = 'BUILDING_US_GUILLOTINE';
...
SET DummyBuildingType = 'BUILDING_US_ROBESPIERRE_HAPPINESS_DUMMY_BUILDING_US_GUILLOTINE', NormalBuildingType = 'BUILDING_US_GUILLOTINE'
WHERE NormalBuildingType = (SELECT DefaultBuilding FROM BuildingClasses WHERE Type = (SELECT BuildingClass FROM Buildings WHERE Type = 'BUILDING_US_GUILLOTINE'));
